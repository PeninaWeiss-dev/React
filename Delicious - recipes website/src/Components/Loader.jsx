...
const Loader = () => {
  return (
    ...
    >
      <div>
        <svg height="80px" width="80px" viewBox="0 0 128 128" className="loader">
          <defs>
          ...
          <g strokeDasharray="175.93 351.86" strokeWidth={12} strokeLinecap="round">
            <g>
              <rect clipPath="url(#loader-eyes)" height={64} width={128} fill="#F5C71A " />
              <g stroke="#F5C71A " fill="none">
            ...
            <g mask="url(#loader-mask)">
              <rect clipPath="url(#loader-eyes)" height={64} width={128} fill=" #bd9a1f "  />
              <g stroke=" #bd9a1f   " fill="none">
                <circle transform="rotate(180,64,64)" r={56} cy={64} cx={64} className="loader__mouth1" />
                <circle transform="rotate(0,64,64)" r={56} cy={64} cx={64} className="loader__mouth2" />
              </g>
            </g>
